    ...
    <body background="pozadina.jpg">
        ...
        <?php   
                ...
                foreach($images as $s)
                {
                    echo '<form name="form1" method="POST" action ="">';
                        echo '<div class="text-center">';
                            ...
                            echo '<img src="Slike/Politic/'.$s.'.jpg" class="img-thumbnail" alt="" width="300" />';
                        echo '</div>';
            ...
            else
            {
                ...
                if(!file_exists("politicip.txt"))
                {
                    $f1=fopen("politicip.txt","w");
                    fclose($f1);
                }
                ...
                else if($check)
                {
                    ...
                    if(!file_exists("Slike/Politic/ocjene.txt"))
                    {
                        $f=fopen("Slike/Politic/ocjene.txt","w");
                        fclose($f);
                    }
                    
                    $file='Slike/Politic/ocjene.txt';
                    ...
                    echo '<div class="text-center">';      
                         echo '<a href="AllRatings.php" class="btn btn-info">Next</a>';
                    echo '</div>';
                    echo '</br>';
                }  
                ...
                {
                    echo '<a href="Politic.php">Return</a>';
                }
            } 
            echo '</br>';
        ?>

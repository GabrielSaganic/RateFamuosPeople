    ...
    <body background="pozadina.jpg">
        ...
        <?php   
                ...
                foreach($images as $s)
                {
                    echo '<form name="form1" method="POST" action ="">';
                        echo '<div class="text-center">';
                            ...
                            echo '<img src="Slike/Singer/'.$s.'.jpg" class="img-thumbnail" alt="" width="300" />';
                        echo '</div>';
            ...
            else
            {
                ...
                if(!file_exists("singerip.txt"))
                {
                    $f1=fopen("singerip.txt","w");
                    fclose($f1);
                }
                ...
                else if($check)
                {
                    ...
                    if(!file_exists("Slike/Singer/ocjene.txt"))
                    {
                        $f=fopen("Slike/Singer/ocjene.txt","w");
                        fclose($f);
                    }
                    
                    $file='Slike/Singer/ocjene.txt';
                    ...
                    echo '<div class="text-center">';      
                         echo '<a href="Politic.php" class="btn btn-info">Next</a>';
                    echo '</div>';
                    echo '</br>';
                }  
                ...
                {
                    echo '<a href="Singer.php">Return</a>';
                }
            } 
            echo '</br>';
        ?>
